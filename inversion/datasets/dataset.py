...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        mirror_conf_map = mirror_conf_map.unsqueeze(0).unsqueeze(0)
        mirror_conf_map = torch.nn.functional.interpolate(mirror_conf_map, (512, 512), mode='bicubic', align_corners=False)
        mirror_conf_map = mirror_conf_map.squeeze(0).squeeze(0)
        
        return image_resized, image, torch.from_numpy(label), mirror_image, torch.from_numpy(mirror_label), mirror_conf_map, fname
